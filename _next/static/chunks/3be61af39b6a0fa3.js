(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 7398, (e, t, r) => {
    "use strict";
    t.exports = {}
}, 560, (e, t, r) => {
    ...
    let n = e.r(1705)._(e.r(1788)).default.createContext(null)
}, 1280, (e, t, r) => {
    "use strict";
    ...
    (() => {
        "use strict";
        "undefined" != typeof __nccwpck_require__ && (__nccwpck_require__.ab = "/ROOT/node_modules/next/dist/compiled/path-to-regexp/");
        var e = {};
        (() => {
            function t(e, t) {
                void 0 === t && (t = {});
            ...
            function i(e, t, r) {
                ...
                for (var n = r.strict, i = void 0 !== n && n, s = r.start, u = r.end, l = r.encode, c = void 0 === l ? function(e) {
                    ...
                    if ("string" == typeof E) _ += a(c(E));
                        ...
                        if (E.pattern)
                            if (t && t.push(E), g || P)
                                if ("+" === E.modifier || "*" === E.modifier) {
                                    var y = "*" === E.modifier ? "?" : "";
                                    _ += "(?:".concat(g, "((?:").concat(E.pattern, ")(?:").concat(P).concat(g, "(?:").concat(E.pattern, "))*)").concat(P, ")").concat(y)
                                } else _ += "(?:".concat(g, "(").concat(E.pattern, ")").concat(P, ")").concat(E.modifier);
                        else {
                        ...
                        } else _ += "(?:".concat(g).concat(P, ")").concat(E.modifier)
                    }
                }
            ...
            function s(e, r, n) {
                if (e instanceof RegExp) {
                    var a;
                    if (!r) return e;
                    for (var u = /\((?:\?<(.*?)>)?(?!\?)/g, l = 0, c = u.exec(e.source); c;) r.push({
                        name: c[1] || l++,
                        prefix: "",
                        suffix: "",
                        modifier: "",
            ...
            }, e.regexpToFunction = n, e.tokensToRegexp = i, e.pathToRegexp = s
        })(), t.exports = e
    })()
}, 8268, (e, t, r) => {
    "use strict";
    ...
    let o = "text/plain",
        ...
        ee = "Your `getServerSideProps` function did not return an object. Did you forget to add a `return`?",
        et = "The `unstable_revalidate` property is available for general use.\nPlease use `revalidate` instead.",
        er = "can not be attached to a page's component and must be exported from the page. See more info here: https://nextjs.org/docs/messages/gssp-component-member",
        ...
        ea = "Pages with `fallback` enabled in `getStaticPaths` can not be exported. See more info here: https://nextjs.org/docs/messages/ssg-fallback-true-export",
    ...
    function u(e, t, r, n) {
        ...
        for (; o.length > 0;) {
            let {
                ...
                segment: r,
                parallelRoutes: l
            } = (0, i.parseLoaderTree)(e), c = (0, s.getSegmentParam)(r);
            if (c && !a.hasOwnProperty(c.param) && !n ? .has(c.param)) switch (c.type) {
                case "catchall":
                case "optional-catchall":
                case "catchall-intercepted-(..)(..)":
                case "catchall-intercepted-(.)":
            ...
            let d = t;
            for (let e of (!(r.startsWith("(") && r.endsWith(")")) && "" !== r && d++, Object.values(l))) o.push({
                tree: e,
                depth: d
            })
        }
    ...
    function d({
        ...
        a && (d = `${a}${d}`);
        let p = !1;
        (0 === d.length || d.length > 30) && (p = !0), isNaN(parseInt(d.slice(0, 1))) || (p = !0), p && (d = t());
        let h = d in n;
        a ? n[d] = `${a}${u}` : n[d] = u;
        let _ = e ? (0, s.escapeStringRegexp)(e) : "";
        return i = h && o ? `\\k<${d}>` : f ? `(?<${d}>.+?)` : `(?<${d}>[^/]+?)`, {
            key: u,
            pattern: c ? `(?:/${_}${i})?` : `/${_}${i}`,
            cleanedKey: d,
            optional: c,
    ...
    function p(e, t, r, n, a, c = {
        ...
        for (let f of (c = structuredClone(c), (0, u.removeTrailingSlash)(e).slice(1).split("/"))) {
            let e, u = i.INTERCEPTION_ROUTE_MARKERS.some(e => f.startsWith(e)),
                ...
                g = u ? p ? .[1] : void 0;
            if (g && p ? .[2] ? (e = t ? o.NEXT_INTERCEPTION_MARKER_PREFIX : void 0, c.intercepted[p[2]] = g) : e = p ? .[2] && c.intercepted[p[2]] ? t ? o.NEXT_INTERCEPTION_MARKER_PREFIX : void 0 : t ? o.NEXT_QUERY_PARAM_PREFIX : void 0, g && p && p[2]) {
                let {
                    key: t,
                    pattern: r,
                    cleanedKey: n,
                ...
                m.push(r), E.push(`/${p[1]}:${c.names[t]??n}${o?i?"*":"+":""}`), c.names[t] ? ? = n
            } else if (p && p[2]) {
                n && p[1] && (m.push(`/${(0,s.escapeStringRegexp)(p[1])}`), E.push(`/${p[1]}`));
                let {
                    key: t,
                    pattern: r,
                    cleanedKey: o,
                ...
                n && p[1] && (l = l.substring(1)), m.push(l), E.push(`/:${c.names[t]??o}${i?u?"*":"+":""}`), c.names[t] ? ? = o
            } else m.push(`/${(0,s.escapeStringRegexp)(f)}`), E.push(`/${f}`);
            r && p && p[3] && (m.push((0, s.escapeStringRegexp)(p[3])), E.push(p[3]))
        }
        return {
    ...
    function o(e, t, r = !0) {
        let i = new URL("undefined" == typeof window ? "http://n" : (0, n.getLocationOrigin)()),
            s = t ? new URL(t, i) : e.startsWith(".") ? new URL("undefined" == typeof window ? "http://n" : window.location.href) : i,
            {
                pathname: u,
                searchParams: l,
                search: c,
    ...
    function a(e) {
        return (void 0 === n && "undefined" != typeof window && (n = window.trustedTypes ? .createPolicy("nextjs", {
            createHTML: e => e,
            createScript: e => e,
            createScriptURL: e => e
    ...
    function g(e) {
        ...
        return {
            ...
            prefetch(t) {
                let r;
                return (r = navigator.connection) && (r.saveData || /2g/.test(r.effectiveType)) ? Promise.resolve() : E(e, t).then(e => Promise.all(p ? e.scripts.map(e => {
                    var t, r, n;
    ...
    let d = "phase-export",
        ...
        U = "react-loadable-manifest.json",
        $ = "server",
        F = ["next.config.js", "next.config.mjs", "next.config.ts", ...a.default ? .features ? .typescript ? ["next.config.mts"] : []],
        B = "BUILD_ID",
    ...
    class h {
        ...
        getDataHref(e) {
            ...
            let r, {
                ...
                E = (0, f.removeTrailingSlash)(p);
            if ("/" !== E[0]) throw Object.defineProperty(Error(`Route name should start with a "/", got "${E}"`), "__NEXT_ERROR_CODE", {
                value: "E303",
                enumerable: !1,
                configurable: !0
            });
            return t = e.skipInterpolation ? m : (0, l.isDynamicRoute)(E) ? (0, i.interpolateAs)(p, m, h).result : E, r = (0, s.default)((0, f.removeTrailingSlash)((0, u.addLocale)(t, d)), ".json"), (0, o.addBasePath)(`/_next/data/${this.buildId}${r}${_}`, !0)
        }
        _isSsg(e) {
    ...
    let o = e.r(1705),
        ...
        _ = e => {
            ...
            o ? (m.innerHTML = o.__html || "", _()) : i ? (m.textContent = "string" == typeof i ? i : Array.isArray(i) ? i.join("") : "", _()) : t && (m.src = t, p.set(t, E)), (0, f.setAttributesFromProps)(m, e), "worker" === s && m.setAttribute("type", "text/partytown"), m.setAttribute("data-nscript", s), c && (e => {
    ...
    function g(e) {
        ...
        if ((0, l.useEffect)(() => {
            ...
            }, [e, o]), ("beforeInteractive" === o || "worker" === o) && (m ? (E[o] = (E[o] || []).concat([{
                id: t,
                src: r,
                onLoad: n,
                onReady: a,
    ...
    }), e.r(2796), ("function" == typeof r.default || "object" == typeof r.default && null !== r.default) && void 0 === r.default.__esModule && (Object.defineProperty(r.default, "__esModule", {
        value: !0
    }), Object.assign(r.default, r), t.exports = r.default)
}, 7742, (e, t, r) => {
    "use strict";
    ...
    }), e.r(8186), ("function" == typeof r.default || "object" == typeof r.default && null !== r.default) && void 0 === r.default.__esModule && (Object.defineProperty(r.default, "__esModule", {
        value: !0
    }), Object.assign(r.default, r), t.exports = r.default)
}, 7285, (e, t, r) => {
    "use strict";
    ...
    async function $(e) {
        ...
        let {
            pathname: r
        } = (0, y.parsePath)(e.asPath), n = (0, S.hasBasePath)(r) ? (0, v.removeBasePath)(r) : r, a = (0, O.addBasePath)((0, b.addLocale)(n, e.locale));
    ...
    function B(e, t, r) {
        let [n, a] = (0, T.resolveHref)(e, t, !0), o = (0, h.getLocationOrigin)(), i = n.startsWith(o), s = a && a.startsWith(o);
        n = F(n), a = a ? F(a) : a;
    ...
    function k(e, t) {
        ...
        return "/404" === r || "/_error" === r ? e : (t.includes(r) || t.some(t => {
            if ((0, _.isDynamicRoute)(t) && (0, g.getRouteRegex)(t).re.test(r)) return e = t, !0
            ...
            if (!i || o || i.includes("__next_data_catchall") || i.includes("/_error") || i.includes("/404") || (o = i), o) {
                if (o.startsWith("/")) {
                    ...
                    return Promise.all([r.router.pageLoader.getPageList(), (0, u.getClientBuildManifest)()]).then(([o, {
                        ...
                        let c = o.includes(l) ? l : k((0, d.normalizeLocalePath)((0, v.removeBasePath)(t.pathname), r.router.locales).pathname, o);
                        if ((0, _.isDynamicRoute)(c)) {
                            let e = (0, E.getRouteMatcher)((0, g.getRouteRegex)(c))(u);
                ...
                let t = (0, y.parsePath)(e),
                    i = (0, w.formatNextPathnameInfo)({ ...(0, j.getNextPathnameInfo)(t.pathname, {
                            nextConfig: n,
                            parseData: !0
                        }),
    ...
    function G({
        ...
        let {
            href: c
        } = new URL(e, window.location.href), f = s => (function e(t, r, n) {
            return fetch(t, {
                credentials: "same-origin",
                method: n.method || "GET",
        ...
        return l && i ? f({}).then(e => ("no-cache" !== e.response.headers.get("x-middleware-cache") && (t[c] = Promise.resolve(e)), e)) : void 0 !== t[c] ? t[c] : t[c] = f(s ? {
            method: "HEAD"
        } : {})
    }
    ...
    function z({
        ...
        if (e === (0, O.addBasePath)((0, b.addLocale)(t.asPath, t.locale))) throw Object.defineProperty(Error(`Invariant: attempted to hard navigate to the same URL ${e} ${location.href}`), "__NEXT_ERROR_CODE", {
            value: "E282",
            enumerable: !1,
            configurable: !0
        });
    ...
    class V {
        ...
        constructor(e, t, r, {
            ...
            if (this.basePath = "", this.sub = c, this.clc = null, this._wrapApp = i, this.isSsr = !0, this.isLocaleDomain = !1, this.isReady = !!(self.__NEXT_DATA__.gssp || self.__NEXT_DATA__.gip || self.__NEXT_DATA__.isExperimentalCompile || self.__NEXT_DATA__.appGip && !self.__NEXT_DATA__.gsp || !R && !self.location.search), this.state = {
                    route: b,
                    pathname: e,
                    query: t,
                    asPath: R ? e : r,
        ...
        async _bfl(t, r, n, a) {
            {
                if (!this._bfl_s && !this._bfl_d) {
                    ...
                    try {
                        ...
                        return z({
                            url: (0, O.addBasePath)((0, b.addLocale)(t, n || this.locale, this.defaultLocale)),
                            router: this
                        }), new Promise(() => {})
                    }
                    let s = {
                ...
                for (let {
                    ...
                    if (e) {
                        let r = (0, s.removeTrailingSlash)(new URL(e, "http://n").pathname),
                            l = (0, O.addBasePath)((0, b.addLocale)(r, n || this.locale));
                        if (u || r !== (0, s.removeTrailingSlash)(new URL(this.asPath, "http://n").pathname)) {
                            for (let e of (o = o || !!this._bfl_s ? .contains(r) || !!this._bfl_s ? .contains(l), [r, l])) {
                                let t = e.split("/");
        ...
        async change(e, t, r, n, a) {
            let o, i;
            if (!(0, I.isLocalURL)(t)) return z({
                url: t,
                router: this
            }), !1;
            let f = 1 === n._h;
            f || n.shallow || await this._bfl(r, void 0, n.locale);
            let d = f || n._shouldResolveHref || (0, y.parsePath)(t).pathname === (0, y.parsePath)(r).pathname,
                p = { ...this.state
                },
                T = !0 !== this.isReady;
            this.isReady = !0;
            ...
            this._inFlightRoute && this.clc && (A || V.events.emit("routeChangeError", U(), this._inFlightRoute, L), this.clc(), this.clc = null), r = (0, O.addBasePath)((0, b.addLocale)((0, S.hasBasePath)(r) ? (0, v.removeBasePath)(r) : r, n.locale, this.defaultLocale));
            let D = (0, R.removeLocale)((0, S.hasBasePath)(r) ? (0, v.removeBasePath)(r) : r, p.locale);
            this._inFlightRoute = r;
            let F = j !== p.locale;
            if (!f && this.onlyAHashChange(D) && !F) {
                p.asPath = D, V.events.emit("hashChangeStart", r, L), this.changeState(e, t, r, { ...n,
                    scroll: !1
                }), C && this.scrollToHash(D);
                try {
                    await this.set(p, this.components[p.route], null)
                } catch (e) {
                    throw (0, c.default)(e) && e.cancelled && V.events.emit("routeChangeError", e, D, L), e
                }
                return V.events.emit("hashChangeComplete", r, L), !0
            }
            ...
            if (this.components[X] ? .__appRouter) return z({
                url: r,
                router: this
            }), new Promise(() => {});
            let Q = !!(K && Y !== K && (!(0, _.isDynamicRoute)(Y) || !(0, E.getRouteMatcher)((0, g.getRouteRegex)(Y))(K))),
                J = !n.shallow && await $({
                    asPath: r,
                    locale: p.locale,
                    router: this
                });
            if (f && J && (d = !1), d && "/_error" !== X && (n._shouldResolveHref = !0, H.pathname = k(X, o), H.pathname !== X && (X = H.pathname, H.pathname = (0, O.addBasePath)(X), J || (t = (0, P.formatWithValidation)(H)))), !(0, I.isLocalURL)(r)) return z({
                url: r,
                router: this
            }), !1;
            q = (0, R.removeLocale)((0, v.removeBasePath)(q), p.locale), Y = (0, s.removeTrailingSlash)(X);
            let Z = !1;
            if ((0, _.isDynamicRoute)(Y)) {
                let e = (0, m.parseRelativeUrl)(q),
                    n = e.pathname,
                    a = (0, g.getRouteRegex)(Y);
                Z = (0, E.getRouteMatcher)(a)(n);
                let o = Y === n,
                    i = o ? (0, M.interpolateAs)(Y, n, G) : {};
                if (Z && (!o || i.result)) o ? r = (0, P.formatWithValidation)(Object.assign({}, e, {
                    pathname: i.result,
                    query: (0, x.omit)(G, i.params)
                })) : Object.assign(G, Z);
                else {
                    let e = Object.keys(a.groups).filter(e => !G[e] && !a.groups[e].optional);
                    if (e.length > 0 && !J) throw Object.defineProperty(Error((o ? `The provided \`href\` (${t}) value is missing query values (${e.join(", ")}) to be interpolated properly. ` : `The provided \`as\` value (${n}) is incompatible with the \`href\` value (${Y}). `) + `Read more: https://nextjs.org/docs/messages/${o?"href-interpolation-failed":"incompatible-href-as"}`), "__NEXT_ERROR_CODE", {
                        value: "E344",
                        enumerable: !1,
                        configurable: !0
                    })
            ...
            f || V.events.emit("routeChangeStart", r, L);
            ...
            try {
                ...
                if (f || n.shallow || await this._bfl(r, "resolvedAs" in i ? i.resolvedAs : void 0, p.locale), "route" in i && J) {
                    Y = X = i.route || Y, L.shallow || (G = Object.assign({}, i.query || {}, G));
                    let e = (0, S.hasBasePath)(H.pathname) ? (0, v.removeBasePath)(H.pathname) : H.pathname;
                    if (Z && X !== e && Object.keys(Z).forEach(e => {
                            Z && G[e] === Z[e] && delete G[e]
                        }), (0, _.isDynamicRoute)(X)) {
                        let e = !L.shallow && i.resolvedAs ? i.resolvedAs : (0, O.addBasePath)((0, b.addLocale)(new URL(r, location.href).pathname, p.locale), !0);
                        (0, S.hasBasePath)(e) && (e = (0, v.removeBasePath)(e));
                        let t = (0, g.getRouteRegex)(X),
                            n = (0, E.getRouteMatcher)(t)(new URL(e, location.href).pathname);
                        n && Object.assign(G, n)
                    }
                }
                if ("type" in i)
                ...
                if (s && s.unstable_scriptLoader && [].concat(s.unstable_scriptLoader()).forEach(e => {
                    ...
                    if (p.isPreview = !!i.props.__N_PREVIEW, i.props.notFound === W) {
                        let e;
                        try {
                        ...
                        if (i = await this.getRouteInfo({
                                ...
                                isPreview: p.isPreview,
                                isNotFound: !0
                            }), "type" in i) throw Object.defineProperty(Error("Unexpected middleware effect on /404"), "__NEXT_ERROR_CODE", {
                            value: "E158",
                            enumerable: !1,
                            configurable: !0
                        })
                ...
                f && "/_error" === this.pathname && self.__NEXT_DATA__.props ? .pageProps ? .statusCode === 500 && i.props ? .pageProps && (i.props.pageProps.statusCode = 500);
                ...
                if (f && ee) {
                    if (i = await this.getRouteInfo({
                            ...
                            isPreview: p.isPreview,
                            isQueryUpdating: f && !this.isFallback
                        }), "type" in i) throw Object.defineProperty(Error(`Unexpected middleware effect on ${this.pathname}`), "__NEXT_ERROR_CODE", {
                        value: "E225",
                        enumerable: !1,
                        configurable: !0
                    });
                    "/_error" === this.pathname && self.__NEXT_DATA__.props ? .pageProps ? .statusCode === 500 && i.props ? .pageProps && (i.props.pageProps.statusCode = 500);
                    try {
                        await this.set(P, i, h)
                    } catch (e) {
                        throw (0, c.default)(e) && e.cancelled && V.events.emit("routeChangeError", e, D, L), e
                    }
                    return !0
                }
                if (V.events.emit("beforeHistoryChange", r, L), this.changeState(e, t, r, n), !(f && !h && !T && !F && (0, N.compareRouterStates)(P, this.state))) {
                    try {
                        await this.set(P, i, h)
                    } catch (e) {
                    ...
                    if (i.error) throw f || V.events.emit("routeChangeError", i.error, D, L), i.error;
                    f || V.events.emit("routeChangeComplete", r, L), d && /#.+$/.test(r) && this.scrollToHash(r)
                }
                return !0
            } catch (e) {
        ...
        async handleRouteInfoError(e, t, r, n, a, o) {
            ...
            if ((0, u.isAssetError)(e) || o) throw V.events.emit("routeChangeError", e, n, a), z({
                url: n,
                router: this
            }), U();
            console.error(e);
        ...
        async getRouteInfo({
            ...
            try {
                ...
                if (y && ("/_error" === t || "/404" === t) && (y.effect = void 0), p && (y ? y.json = self.__NEXT_DATA__.props : y = {
                    ...
                    }), c(), y ? .effect ? .type === "redirect-internal" || y ? .effect ? .type === "redirect-external") return y.effect;
                if (y ? .effect ? .type === "rewrite") {
                    let n = (0, s.removeTrailingSlash)(y.effect.resolvedHref),
                        i = await this.pageLoader.getPageList();
                    if ((!p || i.includes(n)) && (m = n, t = y.effect.resolvedHref, r = { ...r,
                            ...y.effect.parsedAs.query
                        }, a = (0, v.removeBasePath)((0, d.normalizeLocalePath)(y.effect.parsedAs.pathname, this.locales).pathname), e = this.components[m], o.shallow && e && this.route === m && !u)) return { ...e,
                        route: m
                    }
                }
                if ((0, A.isAPIRoute)(m)) return z({
                    url: n,
                    router: this
                }), new Promise(() => {});
                let b = E || await this.fetchComponent(m).then(e => ({
                        Component: e.page,
                ...
                return b.__N_SSP && g.dataHref && T && delete this.sdc[T], this.isPreview || !b.__N_SSG || p || G(Object.assign({}, g, {
                    isBackground: !0,
                    persistCache: !1,
                    inflightCache: this.sbc
                })).catch(() => {}), S.pageProps = Object.assign({}, S.pageProps), b.props = S, b.route = m, b.query = r, b.resolvedAs = a, this.components[m] = b, b
            } catch (e) {
        ...
        async prefetch(e, t = e, r = {}) {
            if ("undefined" != typeof window && (0, C.isBot)(window.navigator.userAgent)) return;
            ...
            n.pathname = k(n.pathname, l), (0, _.isDynamicRoute)(n.pathname) && (o = n.pathname, n.pathname = o, Object.assign(i, (0, E.getRouteMatcher)((0, g.getRouteRegex)(n.pathname))((0, y.parsePath)(t).pathname) || {}), d || (e = (0, P.formatWithValidation)(n)));
            let p = await H({
                fetchData: () => G({
                    dataHref: this.pageLoader.getDataHref({
                        href: (0, P.formatWithValidation)({
            ...
            if (p ? .effect.type === "rewrite" && (n.pathname = p.effect.resolvedHref, o = p.effect.resolvedHref, i = { ...i,
                    ...p.effect.parsedAs.query
                }, c = p.effect.parsedAs.pathname, e = (0, P.formatWithValidation)(n)), p ? .effect.type === "redirect-external") return;
            ...
            }).then(() => !1).catch(() => !1)), this.pageLoader[r.priority ? "loadPage" : "prefetch"](h)])
        }
...
${e.stack}` : e + "")
    ...
    function l(e) {
        ...
        let t = e.digest.split(";"),
            ...
            a = t.slice(2, -2).join(";"),
            o = Number(t.at(-2));
        return r === s && ("replace" === n || "push" === n) && "string" == typeof a && !isNaN(o) && o in i.RedirectStatusCode
    }("function" == typeof r.default || "object" == typeof r.default && null !== r.default) && void 0 === r.default.__esModule && (Object.defineProperty(r.default, "__esModule", {
        value: !0
    }), Object.assign(r.default, r), t.exports = r.default)
}, 8934, (e, t, r) => {
    ...
    for (var m in _) Object.defineProperty(r, m, {
        enumerable: !0,
        get: _[m]
    });
    let E = e.r(1705),
    ...
    let k = "16.0.8",
        H = (0, R.default)(),
        W = !1;
    class X extends P.default.Component {
        componentDidCatch(e, t) {
            this.props.fn(e, t)
        }
        componentDidMount() {
            this.scrollToHash(), n.isSsr && (a.isFallback || a.nextExport && ((0, S.isDynamicRoute)(n.pathname) || location.search || W) || a.props && a.props.__N_SSG && (location.search || W)) && n.replace(n.pathname + "?" + String((0, T.assign)((0, T.urlQueryToSearchParams)(n.query), new URLSearchParams(location.search))), o, {
                _h: 1,
    ...
    async function G(t = {}) {
        ...
        let r = a.assetPrefix || "";
        if (self.__next_set_public_path__(`${r}/_next/`), o = (0, A.getURL)(), (0, D.hasBasePath)(o) && (o = (0, L.removeBasePath)(o)), a.scriptLoader) {
            let {
                initScriptLoader: t
            } = e.r(1457);
            t(a.scriptLoader)
        }
        i = new N.default(a.buildId, r);
    ...
    function z({
        ...
        let t = P.default.useMemo(() => (0, $.adaptForAppRouterInstance)(n), []);
        return (0, g.jsx)(X, {
            fn: e => V({
                App: f,
                err: e
            ...
            children: (0, g.jsx)(U.AppRouterContext.Provider, {
                ...
                children: (0, g.jsx)(F.SearchParamsContext.Provider, {
                    value: (0, $.adaptForSearchParams)(n),
                    children: (0, g.jsx)($.PathnameContextProviderAdapter, {
                        router: n,
                        isAutoExport: self.__NEXT_DATA__.autoExport ? ? !1,
                        children: (0, g.jsx)(F.PathParamsContext.Provider, {
                            value: (0, $.adaptForPathParams)(n),
    ...
    function V(t) {
        ...
        return console.error(s), console.error("A client-side exception has occurred, see here for more info: https://nextjs.org/docs/messages/client-side-exception-occurred"), i.loadPage("/_error").then(({
            page: n,
            styleSheets: a
        }) => l ? .Component === n ? e.A(8761).then(n => e.A(8805).then(e => (t.App = r = e.default, n))).then(e => ({
            ...
            return Promise.resolve(t.props ? .err ? t.props : (0, A.loadGetInitialProps)(r, l)).then(r => ec({ ...t,
                err: s,
                Component: e,
                styleSheets: i,
                props: r
    ...
    function ei() {
        [Q, Z, J, ee].forEach(e => performance.clearMarks(e))
    }

    function es() {
        A.ST && (performance.mark(Z), performance.getEntriesByName(Q, "mark").length && (performance.measure("Next.js-before-hydration", "navigationStart", Q), performance.measure(et, Q, Z)), d && performance.getEntriesByName(et).forEach(d), ei())
    }
    ...
    function eu() {
        ...
        e.length && (performance.getEntriesByName(Q, "mark").length && (performance.measure(er, e[0].name, Q), performance.measure(en, Q, J), d && (performance.getEntriesByName(en).forEach(d), performance.getEntriesByName(er).forEach(d))), ei(), [er, en].forEach(e => performance.clearMeasures(e)))
    }
    ...
    function ec(e) {
        ...
        let E = (0, g.jsxs)(g.Fragment, {
            children: [(0, g.jsx)(K, {
                ...
                children: [q(i, h), (0, g.jsx)(j.Portal, {
                    type: "next-route-announcer",
                    children: (0, g.jsx)(I.RouteAnnouncer, {})
                })]
            })]
        });
        return t = s, r = e => (0, g.jsx)(el, {
            callbacks: [e, m],
            children: (0, g.jsx)(P.default.StrictMode, {
                children: E
            })
        }), A.ST && performance.mark(Q), a = r(eo ? es : eu), ea ? (0, P.default.startTransition)(() => {
            ea.render(a)
